        ...
        <div className="min-h-screen bg-gym-dark flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-gym-gray p-8 rounded-xl shadow-lg border border-gym-light">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-gym-green hover:bg-green-600 text-white font-semibold py-2 rounded-lg transition-colors"
                    >
                        Register
                    </button>
                </form>
                <p className="mt-4 text-center text-gray-400">
                    Already have an account? <Link to="/login" className="text-gym-blue hover:underline">Sign in</Link>
                </p>
            </div>
        </div>
    );
